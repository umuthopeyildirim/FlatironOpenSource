    ...
    <div>
      <CoreBar />
        <div className="mx-3">
            ...
            <ul>
                <li>By visiting this page on our website: <a href="https://flatironopensource.com/privacy" rel="external nofollow noopener" target="_blank">https://flatironopensource.com/privacy</a></li>
            </ul>
        </div>
        <CoreFooter />
    </div>
