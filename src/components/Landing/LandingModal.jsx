...
return (
  <div className="font-sans">
    ...
    <Modal open={visible} className = "w-full text-sm text-white px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg focus:outline-none focus:border-purple-400">
      ...
      <p>By clicking ok, you consent to flatironopensource.com's Cookies and Privacy policies. </p>
      <p>Cookies and Privacy policies, as well as the site's Terms and Conditions, can be found in the footer below </p>
      </Modal.Body>
